...
if("TRUE" STREQUAL "TRUE")
  set(projection_SOURCE_PREFIX /ext2/didigithub/ros/src/projection)
  set(projection_DEVEL_PREFIX /ext2/didigithub/ros/devel)
  ...
  set(projection_INSTALL_PREFIX /ext2/didigithub/ros/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'projection' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Prerit Jaiswal <prerit.jaiswal@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'projection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ext2/didigithub/ros/src/projection/${idir}'.  Ask the maintainer 'Prerit Jaiswal <prerit.jaiswal@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${projection_dep}_FOUND)
      find_package(${projection_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${projection_dep} REQUIRED ${depend_list})
  endif()
